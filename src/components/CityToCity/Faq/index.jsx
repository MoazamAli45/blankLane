...
import faqImg from "../assets-city/Faqs/faq.webp";
import Accordian, { AccordianItem } from "../ui/Accordian";
import review from "../assets-city/Faqs/reviews.svg";
...
"
                ...
                >
                  <div className="flex flex-col space-y-4">
                    <p className="text-[#64666b] text-[14px] font-normal">
                      If that&apos;s the case, please reach out to them
                      directly. You can utilize the chat feature within our app,
                      or you can contact them through the telephone number
                      provided to you one hour before pickup via email and SMS.
                      This message will also include details such as the make,
