      ...
      <div className="grid grid-cols-1 md1:grid-cols-2 gap-x-[5rem] place-content-between gap-y-5">
        ...
        <div className=" flex flex-col gap-3 order-2 md1:order-1">
          ...
          <p className=" text-[16px] md1:max-w-[36rem] w-full text-[#181a1f]">
            ...
            accommodations signals the start of exploration. With
            Blacklane&apos;s limo service, a professional driver ensures
            seamless navigation through your new surroundings. Choose our hourly
            service for added flexibility, with a standby driver available in
            your area.No matter the occasion, Blacklane provides a touch of
            elegance and reliability to elevate your experience. From
            door-to-door service to personalized assistance, we prioritize your
            comfort and satisfaction. Count on us to make every journey
            exceptional. With a global presence in hundreds of cities, Blacklane
            is your trusted partner for enhancing events such as:
          </p>
          {/* EVenTs ==> */}
          <div>
