    ...
    <div className="bg-[#f0f2f7] py-[40px]">
      <div className="container mx-auto px-[16px]">
        <div className="text-center">
          <h1 className="text-[44px] font-semibold">City to City routes</h1>
        </div>
        <div className="py-2 flex justify-between">
          <h1 className="text-[24px] font-medium">Top cities</h1>
          <h1 className="text-[16px] font-medium underline">See all</h1>
        </div>
          ...
          {cardData.map((card, i) => (
            <div className="col-span-12 md:col-span-3" key={i}>
              <div className="rounded-[8px] border border-[#e3e5ea] bg-white">
                ...
                />
                <div className="p-4">
                  <h2 className="  text-[16px]">{card.title}</h2>
                  <p className="  text-[14px] text-[#64666b]">{card.route}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="py-3 flex justify-between">
          <h1 className="text-[24px] font-medium">Top routes</h1>
          <h1 className="text-[16px] font-medium underline">See all</h1>
        </div>
        <div className="grid grid-cols-12 gap-2">
              ...
              <div className="rounded-[8px] border border-[#e3e5ea] bg-white">
                <div className="p-4">
                  <div className="flex gap-3">
                    <h2 className="  text-[16px]">{card.from}</h2>
                    <img
                      src="/assets/images/right-arrow.png"
                      className="w-auto"
                      alt=""
                    />
                    <h2 className="  text-[16px]">{card.to}</h2>
                  </div>
          ...
          <div className="flex justify-between items-center flex-wrap gap-3">
            <div className="">
              <p className="text-[#64666b]">
                <strong>Have a route in mind?</strong>
              </p>
              <p className="text-[#64666b]">
            ...
            <button
              className="text-[#fbfbfd] font-bold rounded-[8px] border-none px-[32px] h-[52px] flex items-center justify-center"
              style={{
