          ...
          <div className="grid grid-cols-12">
            <div className="col-span-6">
              <button
                ...
                className={`tab-button text-[20px] font-bold text-start py-[12px] px-[16px] w-full ${
                  activeTab === 1 ? "active-tab bg-white" : "bg-[#f0f2f7]"
                }`}
              >
                One way
              </button>
            ...
            <div className="col-span-6">
              <button
                ...
                className={`tab-button py-[12px] text-[20px] text-start font-bold px-[16px] w-full ${
                  activeTab === 2 ? "active-tab bg-white" : "bg-[#f0f2f7]"
                }`}
              >
                By the hour
              </button>
              ...
              <div className="p-3">
                <div className="flex gap-2 flex-col">
                  <div className="relative p-2 bg-[#f0f2f7] border-2 border-transparent rounded-[4px] flex flex-col">
                    <label
                      htmlFor=""
                      className="pl-[30px] text-[#64666b] text-[14px] pt-[8px]"
                    >
                      From
                    </label>
                    <div className="flex gap-2 items-center my-2">
                      <svg
                        role="img"
                        aria-label="Icon/pin"
                        className="remixicon-icon icon_default__ov9NA"
                        width="20px"
                        height="20px"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                  ...
                  <button
                    className="text-[18px] px-[32px] h-[52px] text-white items-center justify-center flex rounded-[8px]"
                    style={{
                      background:
                        "linear-gradient(95.14deg,#e52c43,#ff6c00 91.74%)",
                    }}
                  >
                    Search
                  </button>
