export const DownloadApp = () => {
  return (
    <div className="pt-[60px] bg-[#fbfbfd]">
      <div className="container mx-auto px-[16px]">
        <div className="grid grid-cols-12">
          <div className="col-span-12 md:col-span-6">
            <div>
              <h1 className="mg:pt-[64px] pb-[32px] text-[28px] font-bold">
                Download the app
              </h1>
              <p className="tracking-[.3px] text-[16px] font-normal">
                Easily book, change, or cancel rides on the go. Think of it as
                peace of mind in the palm of your hand.
              </p>
              <div className="flex gap-3 py-[28px]">
                <svg
                  className="downloadApp_appStoreLogo__rMQM2"
                  focusable="false"
                  height="35"
                  role="presentation"
                  viewBox="0 0 120 35"
                ...
                >
                  <defs>
                    <path
                      id="a"
                      d="M4.456 8.115L.789 4.503v-.256L4.458.637l4.428 2.475c1.241.695 1.241 1.83 0 2.525L4.54 8.067l-.084.048"
                    ></path>
                    <linearGradient
                      id="b"
                      x1="80.748%"
                      ...
                      y2="49.998%"
                    >
                      <stop offset="0%" stopColor="#EC942D"></stop>
                      <stop offset="100%" stopColor="#FBDE1E"></stop>
                    </linearGradient>
                    <path
                      id="d"
                      d="M15.207 3.692L11.456 0 .386 10.896c.41.426 1.086.479 1.847.054l12.974-7.257"
                    ></path>
                    <linearGradient
                      id="e"
                      x1="86.245%"
                      ...
                      y2="194.81%"
                    >
                      <stop offset="0%" stopColor="#DD4245"></stop>
                      <stop offset="100%" stopColor="#B72162"></stop>
                    </linearGradient>
                    <path
                      id="g"
                      d="M15.207 7.683L2.233.425C1.472 0 .796.053.387.48l11.069 10.896 3.751-3.692"
                    ></path>
                    <linearGradient
                      id="h"
                      x1="-50.749%"
                      ...
                      y2="48.887%"
                    >
                      <stop offset="0%" stopColor="#6CB966"></stop>
                      <stop offset="100%" stopColor="#299567"></stop>
                    </linearGradient>
                  </defs>
          ...
          <div className="col-span-12 md:col-span-6">
            <div>
              <img src="/assets/images/app-phone-mockup_Tablet.webp" alt="" />
            </div>
          </div>
        </div>
      </div>
