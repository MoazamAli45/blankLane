      ...
      <div className="grid md1:grid-cols-2 grid-cols-1 gap-x-[4rem] place-content-between gap-y-4">
        ...
        <div className=" flex flex-col gap-3 mt-3">
          ...
          <p className=" text-[16px] md1:max-w-[36.8rem] w-full text-[#181a1f]">
            ...
            their very essence. That&apos;s why we celebrate the genuine
            dedication of Blacklane chauffeurs. Their commitment goes beyond
            mere job titles, as they strive to enhance every aspect of your
            journey. To truly appreciate the impact of their dedication, reserve
            a chauffeured ride today for yourself, a colleague, or a client.
